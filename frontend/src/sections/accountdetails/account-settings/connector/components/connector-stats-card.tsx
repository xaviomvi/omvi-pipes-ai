...
const CONNECTOR_DISPLAY_NAMES: Record<string, string> = {
  ...
  GOOGLE_DRIVE: ConnectorIdToNameMap[ConnectorId.DRIVE],
  ...
  SHAREPOINTONLINE: ConnectorIdToNameMap[ConnectorId.SHAREPOINT_ONLINE],
  ...
  KNOWLEDGE_BASE: ConnectorIdToNameMap[ConnectorId.UPLOAD],
};

const CONNECTOR_ICONS: Record<string, string> = {
  GOOGLE_DRIVE: '/assets/icons/connectors/drive.svg',
  ...
  KNOWLEDGE_BASE: '/assets/icons/connectors/upload.svg',
};
