...
interface OneDriveConfigFormProps {
  onValidationChange: (isValid: boolean) => void;
  onSaveSuccess?: () => void;
  isEnabled?: boolean;
}

export interface OneDriveConfigFormRef {
...
type OneDriveConfigFormData = z.infer<typeof oneDriveConfigSchema>;

const OneDriveConfigForm = forwardRef<OneDriveConfigFormRef, OneDriveConfigFormProps>(
  ({ onValidationChange, onSaveSuccess, isEnabled }, ref) => {
    const theme = useTheme();
    const [formData, setFormData] = useState<OneDriveConfigFormData>({
      clientId: '',
      clientSecret: '',
      tenantId: '',
    ...
    useEffect(() => {
      try {
        ...
        oneDriveConfigSchema.parse(formData);
        setErrors({});
    ...
    const handleSave = async (): Promise<boolean> => {
      ...
      try {
        ...
        if (error instanceof z.ZodError) {
          ...
          // Handle API errors
          setSaveError('Failed to save OneDrive configuration');
    ...
    return (
      <>
        <Alert variant="outlined" severity="info" sx={{ my: 3 }}>
          Refer to{' '}
          <Link
            href="https://docs.pipeshub.com/individual/connectors/onedrive"
            target="_blank"
            rel="noopener"
          >
            the documentation
        ...
        {isLoading ? (
          ...
          <>
            ...
            {isConfigured && (
              ...
              >
                <Typography variant="h6">OneDrive Configuration</Typography>
            ...
            {saveSuccess && (
              ...
              >
                Configuration saved successfully! You can now use OAuth2 to authenticate with OneDrive.
              </Alert>
            )}
            ...
            {!formData.hasAdminConsent && (
              ...
              >
                ...
                <Box>
                  ...
                  >
                    {tenantUrl}/onedrive/oauth/callback
                  </Typography>
                </Box>
              </Box>
            )}
            ...
            >
              ...
              <Box>
                <Typography variant="body2" color="text.secondary">
                  To configure OneDrive integration, you will need to create an App registration in{' '}
                  <Link
...
export default OneDriveConfigForm;