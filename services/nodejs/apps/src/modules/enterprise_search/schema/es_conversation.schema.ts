...
import { IConversation, IMessage, IFeedback, IMessageCitation, IFollowUpQuestion } from "../types/es_interfaces";
...
const messageSchema = new Schema<IMessage>(
    {
        ...
        contentFormat: { type: String, enum: ["MARKDOWN", "JSON", "HTML"], default: "MARKDOWN" },
...
const conversationSchema = new Schema<IConversation>(
    {
        ...
        conversationSource: {
            type: String,
            enum: [CONVERSATION_SOURCE.ENTERPRISE_SEARCH, CONVERSATION_SOURCE.RECORDS, CONVERSATION_SOURCE.CONNECTORS, CONVERSATION_SOURCE.INTERNET_SEARCH, CONVERSATION_SOURCE.PERSONAL_KB_SEARCH],
            required: true,
        },
...
// Export the model
export const EnterpriseSearchConversation: Model<IConversation> = mongoose.model<IConversation>(
    "conversationSchema",
    conversationSchema,
    "conversationSchema"
);
