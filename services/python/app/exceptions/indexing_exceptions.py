...
class DocumentProcessingError(IndexingError):
    ...
    def __init__(self, message: str = "Failed to process document", doc_id: str = None, details: dict = None):
...
class EmbeddingDeletionError(IndexingError):
    ...
    def __init__(self, message: str = "Failed to delete embeddings", record_id: str = None, details: dict = None):
